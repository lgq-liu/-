    ...
    <script>
        WIDGET = {
            "CONFIG": {
                ...
                "aqiColor": "FFFFFF",
                "borderRadius": "5",
                "key": "a39e4a73c5e44565b8f67d70cee3c2ac"
            }
        };
        window.addEventListener('resize', function(){
            var boxWidth = document.querySelector('.box').offsetWidth;
            var widgetWidth = boxWidth;
            document.querySelector('#he-plugin-standard').style.width = widgetWidth + 'px';
        });
    </script>
    ...
    <div style="margin-top: 10px">
        <div class="box-search-button-group">
            ...
            <div class="box-button-group">
                <a href="views/AddNewCt.jsp">
                    <img src="images/addNewCt.ico" id="add" type="submit" alt="添加">
                </a>
                <a href="BlackCtListServlet">
                    <img src="images/blackCtList.ico" type="submit" alt="黑名单">
                </a>
                <a href="MatterServlet">
                    <img src="images/matter.ico" type="submit" alt="事项">
                </a>
            </div>
        </div>
    </div>
    <div>
        <table border="2" cellspacing="0" id="tbl">
            <tr>
                <th>姓名
            ...
            <c:forEach var="contact" items="${contactList}" varStatus="status">
                <tr>
                    ...
                    <td><a href="DeleteAndRestoreServlet?ct_id=${contact.ct_id}">屏蔽</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        ...
        <div class="pagination">
            ...
            <% } else { %>
            <a href="javascript:void(0);" onclick="goToPage(<%=i%>);"><%= i %>
            </a>
            <% } %>
            <% } %>
...
<script>
    ...
    $(document).ready(function () { //页面元素初始化
        selectBox.addEventListener("change", function() {  //添加性别选择框的事件监听
            ...
            window.location.href = "ContactListServlet?sex=" + selectedValue;
        });
        //排序图标的点击事件
        $('.sort-icon').on('click', function () {
            ...
            window.location.href = "ContactListServlet?sort=" + sort+"&sex="+selectedValue+"&keyword="+keyword;
        });
    ...
    function goToPage(page) {
        ...
        var url = "ContactListServlet"; // 获取当前页面的URL
